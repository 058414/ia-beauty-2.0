...
function finalizarQ3() {
  ...
  if (!biotipo || !linhasCorpo || !comprimento) {
    alert('⚠️ Responda todas as 3 perguntas para continuar');
    return;
  }
  ...
  conteudo.innerHTML = `
    <div style="text-align: center; padding: 40px;">
      ...
      <p style="color: #4CAF50; line-height: 1.8; margin-bottom: 15px; font-weight: bold;">
        ✅ Quadrante Finalizado!
      </p>
      <p style="color: #ccc; line-height: 1.8; margin-bottom: 30px;">
        Você completou os 3 quadrantes! Agora feche este painel e clique em <strong>"PROTOCOLO PERSONALIZADO"</strong> (4º quadrante) para gerar seu Guia Visual integrado.
      </p>
