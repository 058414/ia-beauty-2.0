  ...
  conteudo.innerHTML = `
    <div style="max-width: 800px; margin: 40px auto;">
      <h2 style="color: #E85D9F; font-size: 1.5rem; margin-bottom: 20px; text-align: center;">
        💃 Seu Corpo — Como Linhas & Biotipos Guiam o Corte
      </h2>
  ...
  conteudo.innerHTML = `
    <form id="quiz-corpo-novo" style="max-width: 600px; margin: 40px auto;">
      <div style="margin-bottom: 30px;">
        <h3 style="color: #E85D9F; margin-bottom: 20px; font-size: 1.1rem;">P1: Qual seu Biotipo?</h3>
      ...
      <div style="margin-bottom: 30px; padding-top: 20px; border-top: 1px solid #333;">
        <h3 style="color: #E85D9F; margin-bottom: 20px; font-size: 1.1rem;">P4: Franja?</h3>
        <p style="color: #aaa; margin-bottom: 15px; font-size: 0.9rem;">Como você se relaciona com franja?</p>

        <div class="quiz-option">
          <input type="radio" name="franja" value="sim" id="fra-sim">
          <label for="fra-sim"><strong>Sim</strong> — Uso ou gosto</label>
        </div>
        <div class="quiz-option">
          <input type="radio" name="franja" value="nao" id="fra-nao">
          <label for="fra-nao"><strong>Não</strong> — Não uso, não curto</label>
        </div>
        <div class="quiz-option">
          <input type="radio" name="franja" value="gostaria" id="fra-got">
          <label for="fra-got"><strong>Gostaria</strong> — Nunca usei mas tenho interesse</label>
        </div>
      </div>
