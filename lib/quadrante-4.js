    ...
    <div style="max-width: 1000px; margin: 40px auto;">
      ...
      <div style="text-align: center; margin-top: 40px;">
        ...
        <button class="quadrante-btn" onclick="gerarSinteseFinal()" style="width: 100%; padding: 15px; font-size: 1rem; ${
          ...
          ${q4State.gerando ? "⏳ Gerando seu protocolo..." : "✨ Gerar Recomendação Integrada"}
        </button>
      </div>
    </div>
  `;
...
async function gerarSinteseFinal() {
  ...
  conteudo.innerHTML = `
    <div style="max-width: 900px; margin: 40px auto; text-align: center;">
      <h2 style="color: #6DD5ED; margin-bottom: 30px;">⏳ Gerando seu protocolo, ${nome}...</h2>
  ...
  conteudo.innerHTML = `
    <div style="max-width: 900px; margin: 40px auto;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <h2 style="color: #E85D9F; font-size: 1.5rem; margin: 0;">✨ Seu Protocolo Personalizado, ${nome}</h2>
...
function gerarPDF() {
  ...
  try {
    ...
    doc.text("Protocolo Personalizado de Análise Facial & Recomendação de Corte", margin, 42);
    ...
    const saudacao = `Este é seu protocolo personalizado. Você explorou sua imagem em 4 dimensões e descobriu sua própria INTELIGÊNCIA VISUAL. Este documento consolida tudo e oferece uma recomendação de corte que funciona em SINERGIA com seu rosto, corpo, essência e contexto.`;
