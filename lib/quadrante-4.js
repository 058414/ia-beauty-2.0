  ...
  conteudo.innerHTML = `
    <div style="max-width: 900px; margin: 40px auto;">
      <h2 style="color: #E85D9F; font-size: 1.5rem; margin-bottom: 20px; text-align: center;">
        🎯 ${nome}, Sua Síntese Final
      </h2>

      <p style="color: #ccc; font-size: 1rem; line-height: 1.8; margin-bottom: 30px; text-align: center;">
        Você completou a exploração de si mesma através dos 3 quadrantes, ${nome}. Agora vamos consolidar TUDO em uma recomendação integrada de corte de cabelo.
      </p>
